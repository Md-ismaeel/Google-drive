    ...
    return (
        <div className='w-full mt-2 px-6'>
            ...
            <div className='w-full flex flex-col gap-2'>
                ...
                <NavLink to={'/home'} className='flex justify-start items-center gap-4 cursor-pointer hover:bg-slate-200 px-4 py-1 rounded-full'>
                ...
                <NavLink to={'/my-drive'} className='flex justify-start items-center gap-4 cursor-pointer hover:bg-slate-200 px-4 py-1 rounded-full'>
                ...
                <NavLink to={'/computer'} className='flex justify-start items-center gap-4 cursor-pointer hover:bg-slate-200 px-4 py-1 rounded-full'>
                ...
                <NavLink t0={'/starred'} className='flex justify-start items-center gap-4 cursor-pointer hover:bg-slate-200 px-4 py-1 rounded-full'>
            ...
            <div className='w-full mt-2 flex flex-col gap-2'>
                ...
                <NavLink to={'/'} className='flex justify-start items-center gap-4 cursor-pointer hover:bg-slate-200 px-4 py-1 rounded-full'>
                ...
                <NavLink className='flex justify-start items-center gap-4 cursor-pointer hover:bg-slate-200 px-4 2y-1 rounded-full'>
