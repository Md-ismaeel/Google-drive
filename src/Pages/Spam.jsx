...
import spam from "../assets/empty_state_spam.svg"
        ...
        <div className='w-full relative min-h-screen px-10 py-4 mt-2 bg-white drop-shadow-xl rounded-2xl mb-4'>
            ...
            {user.data?.length < 0 ? (
                ...
                <div className='w-full h-[100%] flex flex-col justify-center items-center gap-2'>
                    <img src={spam} height={"100px"} width={'30%'} />
                    <p className='text-2xl'>Your spam is empty</p>
                    <p>Files in spam won't appear anywhere else in Drive. Files are permanently removed after 30 days.</p>
                </div>
            )}
