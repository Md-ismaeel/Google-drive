    ...
    <div className='w-full relative min-h-screen px-10 py-4 mt-2 bg-white drop-shadow-xl rounded-2xl mb-4'>
      ...
      {user.data?.length < 0 ? (
        ...
        <div className='w-full h-[100%] flex flex-col justify-center items-center gap-2'>
          <img src={trash} height={"100px"} width={'30%'} />
          <p className='text-2xl'>Nothing in the bin</p>
          <p>Move items that you don't need to the bin. Items in the bin will be deleted forever after 30 days.</p>
        </div>
      )}
